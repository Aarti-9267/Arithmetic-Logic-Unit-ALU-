...
REM
REM Generated by Vivado on Mon Jul 21 20:20:42 +0530 2025
...
echo "xvlog --incr --relax -prj alu_zed_tb_vlog.prj"
call xvlog  --incr --relax -prj alu_zed_tb_vlog.prj -log xvlog.log
